...
const Description = () => (
  <div className="text-center">
    ...
    <p className="m-center nosotros-texto">
      ...
      tres barras, tres sectores VIP con mesas y confortables sillones, donde se
      brinda una exclusiva atención personalizada durante toda la noche.
    </p>
    <img
    ...
    <p className="m-center nosotros-texto">
      En su pista posee sonido e iluminación de última generación, ambiente
      climatizado y decoración minimalista. Seguridad interna, salidas de
      emergencia perfectamente señalizadas. Además posee, una gastronomía que
    ...
    <p className="m-center nosotros-texto">
      ...
      para mayores de 25 años los viernes y sábados.
    </p>
    <img
